...
public:
	...
	virtual void set_zoom_factor(float value)= 0;


	virtual vector get_view_angle()= 0;
	virtual void set_view_angle(const vector&angle)= 0;

	virtual float get_current_zoom()= 0;
	virtual void set_current_zoom(float zoom)= 0;
...
public:
    ...
    virtual void reserved4()=0;
   	virtual hud_camera_logic* get_hud_camera_logic()= 0;
